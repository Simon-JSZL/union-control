...
public class RunningAnalysisMockService {
    ...
    private static void requireCasSession(String cookieHeader) {
        LocalAuth.authenticate(cookieHeader);
    }
    ...
    private static class Org {
        ...
        private Map<String, Object> row() {
            return RunningAnalysisMockService.row(
